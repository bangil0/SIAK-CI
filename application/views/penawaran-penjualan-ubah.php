  ...
  <section id="container" >
   ...
   <div class="" style=" box-shadow: inset 0px 1px 0px #fff; padding: 30px">
      <div class="form-group">
         <label>Bagian Atas<span style="font-size: 11px; font-weight: normal; margin-left: 5px">(<a href="sales-quote-default-heading-form?Referrer=b3958ceb-a846-4447-8e37-c230a2a20225&amp;Key=888da62a-d33c-42f6-b15e-39c151306135&amp;FileID=a5578f2c-1b18-4b54-8840-bf278d5b705b">Jadikan default</a>)</span></label>
      ...
      <div class="form-group">
         ...
         <div class="controls">
            <div>
               <div class="select2-container select2-allowclear" id="s2id_autogen1" style="width: 300px">
                  <a href="javascript:void(0)" class="select2-choice" tabindex="-1">   <span class="select2-chosen" id="select2-chosen-2">2 coir</span><abbr class="select2-search-choice-close"></abbr>   <span class="select2-arrow" role="presentation"><b role="presentation"></b></span></a><label for="s2id_autogen2" class="select2-offscreen"></label><input class="select2-focusser select2-offscreen" type="text" aria-haspopup="true" role="button" aria-labelledby="select2-chosen-2" id="s2id_autogen2">
               ...
               <input type="hidden" style="width: 300px; display: none;" data-bind="select2data: To" data-autocomplete="sales-invoice-contact-autocomplete?FileID=a5578f2c-1b18-4b54-8840-bf278d5b705b" data-placeholder="" tabindex="-1" title="" value="bf3a955b-a4e7-482a-b449-42da64b48fac">
            </div>
         </div>
      </div>
