                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                        <table id="example" class="table table-bordered table-striped">
                             ...
                             <a href="<?php echo base_url(); ?>inventory_baru" class="btn btn-default btn-sm">Inventory Baru</a>
                            <hr>
                              <thead>
                              <tr>
                                  <th>Kode barang</th>
...
=======
                                  <td>Action</td>
>>>>>>> 5730c061a3d6b6d7877f34f3e5d077e69334b832
                              </tr>
                              </thead>
                              <tbody>
                                <?php if(!empty($inventory_list)): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td> <?php echo $inventory_item['deskripsi']; ?></td>
                                        <td> <?php echo $inventory_item['kode_pajak']; ?></td>
                                        <td> <?php echo $inventory_item['kode_pelacakan']; ?></td>
                                        <td> <?php echo $inventory_item['warna']; ?></td>
                                        <td> <?php echo $inventory_item['kategori']; ?></td>
                                        <td>
