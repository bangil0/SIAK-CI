                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table id="example" class="table table-striped table-advance table-hover">
                             ...
                             <a href="pelanggan-baru.php" class="btn btn-default btn-sm">Pelanggan Baru</a>
                            ...
                            <hr>
                              ...
                              <tr>
                                  ...
                                  <td>
                                      ...
                                      <a href="pelanggan-ubah.php" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                  </td>
                              </tr>
                              </tbody>
                          </table>
