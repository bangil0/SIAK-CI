                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table id="example" class="table table-striped table-advance table-hover">
                             ...
                             <a href="inter_account_transfer_baru.php" class="btn btn-default btn-sm">new inter account transfer</a>
                            ...
                            <hr>
                              ...
                              <tr>
                                  ...
                                  <td>
                                      ...
                                      <a href="inter_account_transfer_ubah.php" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
