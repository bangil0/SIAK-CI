                              ...
                              <table style="width: 100%; border-spacing: 10px; border-collapse: separate">
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td><input type="text" id="email-modal-subject" class="form-control input-sm" style="width: 100%" name="Subject" value="Reimburse" placeholder="Reimburse"></td>
                                    </tr>
                                    <tr>
   ...
   <div class="panel-body well">
      <div id="printable-content" class="panel" style="max-width: 800px; font-size: 12px; padding: 1px; border-radius: 0px">
         <table style="padding: 30px">
               ...
               <tr>
                  <td colspan="99">
                     <table style="margin-bottom: 20px">
                        <tbody>
                           <tr>
                              <td style="font-weight: bold; font-size: 32px">Reimburse</td>
                           </tr>
                        </tbody>
                     </table>
                     <table style="margin-bottom: 20px">
                        <tbody>
                           <tr>
                              ...
                              <td style="border-right-width: 1px; padding-right: 20px; text-align: right">
                                 ...
                                 <div style="margin-bottom: 10px">3-Mar 18</div>
                     ...
                     <div style="font-size: 14px; font-weight: bold; margin-bottom: 20px">aa</div>
                  </td>
               </tr>
               <tr>
            ...
            <tbody>
               <tr>
                  <td style="padding: 5px 10px; text-align: left; border-left-width: 1px">aaa</td>
                  <td style="padding: 5px 10px; text-align: center; border-left-width: 1px; white-space: nowrap; width: 80px">1</td>
                  <td style="padding: 5px 10px; text-align: right; border-left-width: 1px; white-space: nowrap; width: 80px">20,00</td>
                  <td style="padding: 5px 10px; text-align: right; border-left-width: 1px; border-right-width: 1px; white-space: nowrap; width: 80px">20,00</td>
               </tr>
               <tr>
               ...
               <tr>
                  ...
                  <td style="border-left-width: 1px; white-space: nowrap; border-right-width: 1px; border-bottom-width: 1px; padding: 5px 10px; text-align: right; font-weight: bold">20,00</td>
               </tr>
            </tbody>
         </table>
      </div>
      ...
      <table style="border-collapse: separate">
         <tbody>
            <tr>
               ...
               <td style="border-left: 1px solid #fff; padding-left: 10px"><span class="btn btn-default btn-sm btn-file" style="font-weight: bold">Lampiran Baru&nbsp;…<input type="file" id="fileupload" name="files" data-url="new-attachment?Source=0da17ba8-f41b-4f88-969b-1bd12987310c&amp;FileID=a5578f2c-1b18-4b54-8840-bf278d5b705b"></span></td>
            </tr>
         </tbody>
      </table>
   </div>
   <script src="resources/fileupload/jquery-ui-widget.js" type="text/javascript"></script><script src="resources/fileupload/jquery-iframe-transport.js" type="text/javascript"></script><script src="resources/fileupload/jquery-fileupload.js" type="text/javascript"></script><script type="text/javascript">$(function () {
      ...
      $.ajax({
          ...
          .success(function(msg) {
              window.location.href = 'view-attachment?Referrer=d358e7d5-599f-456c-83f7-2204dfb7850f&FileID=a5578f2c-1b18-4b54-8840-bf278d5b705b&Key='+key;
          });
      };
