...
<html lang="en">
  ...
  <div class="">
   ...
   <div class="" style="box-shadow: inset 0px 1px 0px #fff; padding: 30px">
      <table>
                                <h3>Pengeluaran transaksi kas</h3>
                        <hr>
         <tbody>
            <tr>
               <td>
      ...
      <div class="form-group">
         ...
         <div class="controls">
            <div>
               ...
               <input type="hidden" style="width: 300px; display: none;" data-bind="select2data: CashAccount" data-autocomplete="cash-account-autocomplete?FileID=a5578f2c-1b18-4b54-8840-bf278d5b705b" data-placeholder="Akun tidak terdefinisi" tabindex="-1" title="">
            </div>
         </div>
      </div>
      <div class="form-group">
