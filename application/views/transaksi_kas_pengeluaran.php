...
<html lang="en">
  <head>
    ...
    <title>Transaksi Kas Pengeluaran</title>
  ...
  <section id="container" >
   ...
   <table>
     <h4 style="display:inline-flex;margin-right:30px">Pengeluaran</h4>
                              <hr>
      <tbody>
         <tr>
            <td>
   ...
   <table id="dynamic_field" class="order-list">
      ...
      <tbody class="ko_container ui-sortable">
         ...
         <td id="akun_row" colspan="3" style="text-align: left;"><div class="controls">
                     <select name="akun[]" data-style="btn-default btn-lg" data-width="350px" class="selectpicker akun" data-size="7" multiple data-max-options="1" data-live-search="true" onchange="getAkun(this)" title="Akun Belum Dipilih" id="akun_select">
         ...
         <div class="controls">
                     <select name="pelanggan[]" data-style="btn-default btn-lg" class="selectpicker pelanggan" data-size="7" multiple data-width="150px" data-max-options="1" data-live-search="true" title="Pelanggan" id="pelanggan">
                        <option value="Interest Received">Interest Received</option>
                     </select>
                  </div>
         </td>
   ...
   <div class="form-group"><label>Catatan</label><textarea name="catatan" class="form-control input-sm" style="width: 400px; height: 100px" name="catatan" spellcheck="true"></textarea></div>
    ...
    function getAkun(sel){
        var ids = $(sel).closest("tr").attr('id');
          if(sel.value == "Pengeluaran Tagihan" || sel.value == "Piutang Dagang" ) {
            ...
            $('#inp_alt_'+ids).show();
            $('#alt_'+ids).html("");
            $('#alt_'+ids).append('<input id="inp_alt_row'+counter+'" name="pelanggan[]" value="-" type="hidden"/>');
          }
       }
    </script>
    ...
    //untuk mengirim data ke database
      $('#btnCreate').click(function(){
           $.ajax({
                url: '<?php echo base_url(); ?>proses/transaksi_kas_pengeluaran_save/insert',
                method: 'POST',
