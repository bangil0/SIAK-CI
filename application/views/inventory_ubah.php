...
<section id="main-content">
  <section class="wrapper">
    <div class="row mt">
     ...
     <?php echo form_open('inventory_ubah/'.$inventory['kode_barang']); ?>
     <table>
           ...
           <tr>
              <td>
                 <div class="form-group">
                    ...
                    <div class="controls">
                      <input type="text" name="harga_beli" value="<?php echo $inventory['harga_beli'] ?>" class="form-control input-sm" >
                    </div>
                 </div>
              </td>
              <td style="padding-left: 10px">
                 <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="harga_jual" value="<?php echo $inventory['harga_jual'] ?>" class="form-control input-sm">
                 </div>
              </td>
           </tr>
        </tbody>
           ...
           <tr>
              <td>
                 <div class="form-group">
                    ...
                    <div class="controls">
                      <input type="text" name="kode_barang" value="<?php echo $inventory['kode_barang'] ?>" class="form-control input-sm" readonly>
                  </div>
                 </div>
              </td>
              <td style="padding-left: 10px">
                 <div class="form-group">
                    ...
                    <div class="controls">
                      <input type="text" name="jenis_barang" value="<?php echo $inventory['jenis_barang'] ?>" class="form-control input-sm">
                    </div>
                 </div>
              </td>
              <td style="padding-left: 10px;" id="sesuai">
                 <div style="padding-left: 10px" class="form-group">
                    ...
                    <div class="controls">
                      <input type="text" name="nama_satuan" value="<?php echo $inventory['nama_satuan'] ?>" class="form-control input-sm">
                 </div>
              </td>
           </tr>
        </tbody>
     ...
     <div class="form-group">
        ...
        <div class="controls">
          <textarea name="deskripsi" class="form-control input-sm" style="width: 400px; height: 80px" spellcheck="true"><?php echo $inventory['deskripsi'] ?></textarea>
        </div>
    </div>
       ...
       <div class="form-group">
          ...
          <div class="controls">
            <select class="form-control input-sm" name="kode_pajak">
              <option value="<?php echo $inventory['kode_pajak'] ?>"><?php echo $inventory['kode_pajak'] ?></option>
        ...
        <div class="form-group">
           ...
           <div class="controls">
             <select class="form-control input-sm" name="kode_pelacakan">
               <option value="<?php echo $inventory['kode_pelacakan'] ?>"><?php echo $inventory['kode_pelacakan'] ?></option>
         ...
         <div class="form-group">
            <label>Warna</label>
            <div class="controls">
              <input type="text" name="warna" class="form-control input-sm" value="<?php echo $inventory['warna'] ?>">
            </div>
          </div>
          ...
          <div class="form-group">
             ...
             <div class="controls">
               <select class="form-control input-sm" name="kategori">
                 <option value="<?php echo $inventory['kategori'] ?>"><?php echo $inventory['kategori']  ?></option>
