      ...
      <table>
         <tbody>
            <tr>
                     ...
                     <div class="controls">
                        <div>
                           <div class="select2-container select2-allowclear" id="s2id_autogen1" style="width: 300px">
                              <a href="javascript:void(0)" class="select2-choice" tabindex="-1">   <span class="select2-chosen" id="select2-chosen-2">faia,s</span><abbr class="select2-search-choice-close"></abbr>   <span class="select2-arrow" role="presentation"><b role="presentation"></b></span></a><label for="s2id_autogen2" class="select2-offscreen"></label><input class="select2-focusser select2-offscreen" type="text" aria-haspopup="true" role="button" aria-labelledby="select2-chosen-2" id="s2id_autogen2">
                           ...
                           <input type="hidden" style="width: 300px; display: none;" data-bind="select2data: CreditAccount" data-autocomplete="inter-account-transfer-account-autocomplete?FileID=a5578f2c-1b18-4b54-8840-bf278d5b705b" data-placeholder="" tabindex="-1" title="" value="24b896dd-c8fb-4ad4-b834-ed443dcd8125">
                        </div>
                     </div>
                  </div>
               </td>
               ...
               <td>
                  <div class="form-group" data-bind="visible: CreditAccount() != null &amp;&amp; CreditAccount().type == 'bank'">
               ...
               <td>
                  <div class="form-group" data-bind="visible: CreditAccount() != null &amp;&amp; CreditAccount().type == 'bank' &amp;&amp; CreditClearStatus() == 'Cleared'">
                     <label>&nbsp;</label>
