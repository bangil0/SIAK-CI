                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                        <table id="example" class="table table-bordered table-striped">
                              <h4 style="display:inline-flex;margin-right:30px">Laporan Laba</h4>
                             <a href="<?php echo base_url(); ?>laporan_laba_baru" class="btn btn-default btn-sm">Laporan Laba Baru</a>
                            <hr>
                              <thead>
                              <tr>
                                  <th>Dari</th>
