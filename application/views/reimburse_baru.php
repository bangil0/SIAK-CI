...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url(); ?>/akuntansi.png">
    <!-- Bootstrap core CSS -->
      ...
      <div class="form-group">
         ...
         <div class="controls">
            <div class="select2-container" id="s2id_autogen1" style="width: 300px">
               <a href="javascript:void(0)" class="select2-choice select2-default" tabindex="-1">   <span class="select2-chosen" id="select2-chosen-2">Diterima dari</span><abbr class="select2-search-choice-close"></abbr>   <span class="select2-arrow" role="presentation"><b role="presentation"></b></span></a><label for="s2id_autogen2" class="select2-offscreen"></label><input class="select2-focusser select2-offscreen" type="text" aria-haspopup="true" role="button" aria-labelledby="select2-chosen-2" id="s2id_autogen2">
            ...
            <select style="width: 300px; display: none;" data-bind="select2data: ExpenseClaimPayer" data-placeholder="Diterima dari" tabindex="-1" title="">
               <option></option>
            </select>
         </div>
      </div>
            ...
            <tr data-select2height="46">
               ...
               <td style="vertical-align: top" data-bind="attr: { colspan: Item() == null &amp;&amp; Helper() != null &amp;&amp; (Helper().id == '054dfae1-c34a-475e-abde-49e0385ffc9a' || Helper().id == '650a36fe-801f-4031-8d5b-ab422d061fca' || Helper().id == 'f728124f-c6b6-4dad-82c5-22fc0d8d0571' || Helper().id == 'd1489e95-bb28-4f5d-b42e-67d3291b3893' || Helper().id == '059dbfb9-1c80-4043-887f-0fc441099fe0') ? '1' : '3' }" colspan="3">
                  ...
                  <div data-bind="visible: Item() == null">
                     <div class="select2-container" id="s2id_autogen3" style="width: 100%;">
                        <a href="javascript:void(0)" class="select2-choice select2-default" tabindex="-1" style="height: 48px;">   <span class="select2-chosen" id="select2-chosen-4">Akun tidak terdefinisi</span><abbr class="select2-search-choice-close"></abbr>   <span class="select2-arrow" role="presentation"><b role="presentation"></b></span></a><label for="s2id_autogen4" class="select2-offscreen"></label><input class="select2-focusser select2-offscreen" type="text" aria-haspopup="true" role="button" aria-labelledby="select2-chosen-4" id="s2id_autogen4">
                        <div class="select2-drop select2-display-none select2-with-searchbox">
                     ...
                     <select data-bind="select2data: Helper" data-placeholder="Akun tidak terdefinisi" data-width="100%" tabindex="-1" title="" style="display: none;">
                        ...
                        <optgroup label="Ekuitas"></optgroup>
                        <optgroup label="Tak terkategori"></optgroup>
                     </select>
                  </div>
               </td>
